...
3. Vào folder FrontEnd (Cd vào Framework muốn dùng):
    a. VueJS:
    ...
    c. ReactJS:
        - Kiểm tra xem đã cài đặt ReactJS chưa: npx create-react-app --version (nếu chưa cài đặt thì mở CMD máy và chạy lệnh: npm install -g create-react-app)
        - Chạy lệnh console trong VSC: npm i
        - npm start để khởi động
